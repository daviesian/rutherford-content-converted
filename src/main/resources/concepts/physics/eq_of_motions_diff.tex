...
\qq{If the displacement is given by \value{s}{4t - 5 t\sup2}, what is \vari{v}?}{
...
\subsection*{Quick Question}
\qq{What is the acceleration of an object if its displacement is the same as that given in question 1, \value{s}{4t - 5 t\sup2}?}{
\begin{equation}
...
\label{s}
\end{eqnarray}
where \vari{s\s0} is the position of the car at \value{t}{0}. 
...
\end{eqnarray}
If the initial position is \value{s\s0}{0}, this equation can be rearranged to:
\begin{equation}
v^2 = u^2 + 2as
\end{equation}
\end{document}
