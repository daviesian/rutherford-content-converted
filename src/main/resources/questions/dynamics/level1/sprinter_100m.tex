...
{An \quantity{80}{kg} sprinter runs a \quantity{100}{m} race in \quantity{10.4}{s}. He accelerates to \quantity{9}{m\,s\sup{-1}} in the first \quantity{1.2}{s} with constant acceleration (this is a simplified model). Use \valuedef{g}{10}{m\,s\sup{-2}}.
\begin{enumerate}
...
legs to the weight of his whole body supported by his legs? 
	...
	\item How much energy does he convert in \quantity{1.2}{s}?
