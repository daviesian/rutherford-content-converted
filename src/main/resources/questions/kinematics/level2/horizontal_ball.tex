...
{\exposition{A ball is thrown horizontally with a speed of 30~m~s$^{-1}$ from a height of 70~m.} \question{How far has the ball travelled horizontally when it first hits the ground?}
\vspace{-0.3cm}
}
...
\end{align*}
\answer{The ball has travelled 113 m horizontally when it first hits the ground}
}
\end{problem}