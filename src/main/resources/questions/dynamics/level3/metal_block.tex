...
{A metal block of mass \vari{m} rests on a rough wooden surface. A thread is attached to the right side of the block and a tension is applied to cause it to move. The motion is opposed by a constant frictional force $F_r$ between the block and the surface.
\begin{enumerate}
	\item Draw a diagram to show all the forces on the block immediately after motion commences.
	\item When the tension in the thread is \vari{T}, the acceleration of the block is measured to be \vari{a}. Calculate the new acceleration, $a_n$, if the tension is increased to $\frac{5}{4}T$.
	\item With the tension of $\frac{5}{4}T$ applied, the block accelerates from rest but after a time \vari{t} the string breaks. Explain the subsequent motion of the block, and also show that it travels a total distance of 
	\begin{equation*} 
	s = \frac{1}{2} \left(a_{n} + \frac{a_{n}^{2}m}{F_{r}} \right)t^{2}
	\end{equation*} 
	from its initial position.
	\item Given that \value{T}{400}{N,} \value{m}{100}{kg}, \value{t}{2}{s} and $a=0.1$ {m\,s\sup{-2}}, calculate the work done by the block after the string breaks.
\end{enumerate}
}
