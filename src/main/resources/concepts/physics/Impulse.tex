...
\qq{An impulse is applied to a ball of mass, \quantity{500}{g}, according to the force-time relation shown in figure \ref{impulse2}  in the same direction as its initial velocity.  What is the final velocity of the ball if it has an initial velocity of \quantity{10}{m\,s\sup{-1}} and the parameters of the force-time graph are, \valuedef{t_f}{1}{s}, \valuedef{F_i}{5}{N} and \valuedef{F_f}{10}{N}.} {\value{v}{25}{m\,s\sup{-1}} in the direction of motion.}\nl
\qq{A pram complete with baby (\quantity{20}{kg}) is left \quantity{1}{km} up along a straight path from the bottom of a hill which is inclined at \vari{30^\circ} to the horizontal. The pram's brakes fail and the pram begins to perfectly roll down the hill under gravity.   What impulse will be required to stop the pram at the bottom of the hill? [Let the acceleration due to gravity, \valuedef{g}{10}{m\,s\sup{-2}}].} {\value{I}{2000}{N\,s} in the direction opposite to the motion of the pram.}\nl
