...
In order for the car to travel in a circle we require \value{F_y}{0}{N}, since there is no vertical acceleration, and \value{F_x}{mv^2/R}, the magnitude of the centripetal force. Therefore
...
\end{figure}
\\
The frictional force \value{\vtr{F}}{\mu \vtr{N}}{} at the point of slipping and has both horizontal and vertical components. Notice how it acts down the slope, since at too high a speed the car will slip up the corner, and friction always opposes the motion. Now we require
...
\end{align*}
then substituting in \value{F}{\mu N} and for \vari{m} (using the expression above) in equation \eqref{eq:slopetwo} we find
