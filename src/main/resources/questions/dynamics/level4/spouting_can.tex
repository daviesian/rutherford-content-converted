...
{\exposition{The 'spouting can', as shown in Figure \ref{fig:Dynamics_Spouting_Can}, is sometimes used to demonstrate the variation of pressure with depth. When the corks are removed from the tubes in the side of the can, water of density \vari{\rho} flows out with a speed that depends on depth.
...
\begin{enumerate} 
\item \question[a]{If the level of water in the can is maintained constant, calculate the work done by hydrostatic pressure when volume \vari{\Delta V} leaves a tube at a depth \vari{h} below the surface.}

\item \exposition{Assuming that all this work provides the kinetic energy of the emerging water, show that the speed \vari{v} of efflux (outflow) is \vari{\sqrt{2gh}}.}

\item \exposition{In a certain can, the three tubes are set at equal distances \vari{a} above the base of the can. When asked to draw the paths of the water coming from the three jets (the overall depth of the water being \vari{4a}), a student made the sketch shown  in Figure \ref{fig:Dynamics_Spouting_Can_2}. \question[b]{Find the values of the distances \vari{x_{1}}, \vari{x_{2}} and \vari{x_{3}} in terms of \vari{a}, and sketch a better diagram.}
...
{The key equation is \valuedef{P}{h\rho g}{}, where \vari{P} is pressure \valuedef{}{\frac{\text{force, F}}{\text{area, A}}}{}. With some rearranging we can get this into a more useful form for the information we have been given:
