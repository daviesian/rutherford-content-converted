...
\begin{enumerate}
	...
	\item \question[b]{Show that the momentum of the section of chain within the tube has horizontal component \vari{\rho lv}.}
	\item  \question[c]{Show further that the horizontal component of the force on the chain is:
	\begin{equation*} 
	\frac{2g \rho}{l(8 + \pi)} \left( 9l^{2} - 6lx - 2x^{2} \right) 
	\end{equation*}}
\end{enumerate}

\stree{Hint:}{\begin{enumerate}
...
Equating the KE and \quantity{\Delta}{GPE} we find:
	...
	% v^{2} &= \frac{\frac{1}{2}\rho g x \left[6l + x\right]}{\frac{1}{2}\rho l \left(4 + \frac{\pi}{2}\right)} \\ 
	 \answer[a]{v^{2} &= \frac{2gx}{(8 + \pi)l}(6l + x)}
	 \end{eqnarray*}
