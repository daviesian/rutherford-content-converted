...
%					%left: | l |
  ...
  *The \textit{Thinking distance} is the distance travelled by the car during the driver's reaction time.
  ...
  \begin{enumerate}
  	\item Using equations, explain why thinking distance is directly proportional to speed whereas braking distance is not. (i.e. give the separate equations which govern thinking and braking distances) %website input?
