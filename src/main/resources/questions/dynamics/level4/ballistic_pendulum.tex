...
}{\stress{Adapted with permission from UCLES, Higher School Certificate Physics, June 1929, Paper 2, Question 2.}}{The initial situation is shown in Figure \ref{fig:Dynamics_ballistic}:
\begin{figure}[h]
	\centering
