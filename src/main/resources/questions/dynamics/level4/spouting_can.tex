...
\begin{figure}[h]
	\centering
	\includegraphics[width=0.4\textwidth]{Dynamics_Spouting_Can}
...
\begin{figure}[h]
	\centering
	\includegraphics[width=0.4\textwidth]{Dynamics_Spouting_Can_2}
...
\item The key equation is \value{P}{h\rho g}{}, where \vari{P} is pressure \value{}{\frac{\text{force, F}}{\text{area, A}}}{}. With some rearranging we can get this into a more useful form for the information we have been given:
...
\end{equation*} 
And, since \value{\Delta V \times \rho}{}{mass,}\vari{m} 
\begin{equation*} 
 & \frac{1}{2}mv^{2} = mgh 
 \end{equation*}
...
\item We are interested in how far the water travels horizontally, which we can find using \value{distance}{speed \times time}{}. However, since each hole is at a different height (hence also a different depth below the surface), both the horizontal speed and the time taken for the water to fall to the ground will be different for the holes. We will have to create a general equation for \vari{x_{n}}, where \value{n}{1}{} represents the top hole, \value{n}{2}{} the middle hole and \value{n}{3}{} the bottom hole. It is easy to find an expression for the speed out of each hole \vari{v_{n}} using the equation calculated above: \value{h}{na}{}, so \value{v_{n}}{\sqrt{2gna}}{}. Now we can use SUVAT to find an expression for \vari{t_{n}}.
...
\begin{figure}[h]
	\centering
	\includegraphics[width=0.4\textwidth]{Dynamics_Spouting_Can_3}
