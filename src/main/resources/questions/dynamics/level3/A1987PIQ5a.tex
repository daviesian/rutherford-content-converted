...
{The correct answer is (b). This can be seen by conserving energy; the initial \value{h}{\frac{v\sup{2}}{2g}}{} and the second height would be %$h_{2} = \frac{v^{2}}{8g} = \frac{1}{4}h$.
\value{h\s{2}}{\frac{2v\sup{2}}{9}} = \vari{\frac{4}{9}h}.
 Motion where gravitational potential is the only energy loss is independent of mass, since the \vari{m} cancels out in \value{\frac{1}{2}mv\sup{2}}{mgh}$.
% \\ \\ \\
