...
\stress{Hint:} A gradient of 1 in 5 means that for every \quantity{5}{m} horizontally, \quantity{1}{m} is gained in vertical height. It is also called a slope of \quantity{20}{\%}.}
