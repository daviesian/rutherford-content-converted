...
\end{equation*}
\item The upward force on the block can be found from Newton's Second Law; we can find the smaller acceleration from the time it takes to fall, and use this in \value{\vtr{F}}{m\vtr{a}}{}. The acceleration was equal to \vari{\frac{2d}{t^{2}}} in symbols, and here \value{t}{10}{s} so:
\begin{equation*} 
