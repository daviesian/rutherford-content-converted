%% ID: newtonii
%% VIDEOS: NewtonII.mp4
%% QUESTIONS: a_toboggan, firing_the_rockets, starting_w_basics, the_lift, a_well, on_ice, coiled_rope, launching_a_rocket, hailstorm, javelin_thrower, powering_up
...
\qq{If a resultant force of \quantity{20}{N} acts horizontally on a mass of \quantity{10}{kg}, what will be the resulting acceleration, \vari{a}?}{\valuedef{\vtr a}{2}{m\,s\sup{-2}}}\nl
