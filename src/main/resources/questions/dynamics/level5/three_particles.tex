...
{Three identical particles \vari{A}, \vari{B}, and \vari{C} are moving in a plane and, at time \vari{t}, their position vectors, \vari{\vtr{a}}, \vari{\vtr{b}}, \vari{\vtr{c}}, with respect to an origin \vari{O} are:
\begin{eqnarray*}
