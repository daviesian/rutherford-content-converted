...
\begin{itemize}
\item[1.] \qq{If a resultant force of $20$ N acts horizontally on a mass of $10$ kg, what will be the resulting acceleration, $a$?} {\color{red}[${\vtr a}=2$ ms$^{-2}$]\color{black}}
\item[2.] \qq{A block of mass $M$ is being pulled along a frictional surface by a rope with tension, ${\vtr T}$ .  The opposing frictional force due to the surface is ${\vtr F_r}$.  What is the acceleration of the block?}  {\color{red}
\begin{equation}
