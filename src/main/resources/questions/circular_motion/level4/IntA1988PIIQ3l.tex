...
The gravitational force \vari{F\s{A}} between the satellite and the Moon is in the inward radial direction and its magnitude is given by the equation 
\begin{equation*}
F_A=GMm/R^2
\end{equation*}
...
\emph{Hint:} The radius of the Moon is \quantity{1.74\times 10\sup6}{m}, the mass of the Moon is \quantity{7.35\times 10\sup{22}}{kg} and Newton's Gravitational Constant, \value{G}{6.67 \times 10\sup{-11}}{N\,m$\sup{2}$\,kg$\sup{-2}$}.} 
