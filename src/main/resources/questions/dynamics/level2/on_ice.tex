...
\begin{enumerate}
	\item The rock accelerates at \quantity{4.0}{m\,s\sup{-2}}; find the direction in which it moves with respect to North. What is the mass of the rock?
	\item The forces continue to act so that the rock moves in a straight line for \quantity{6.0}{s}. Calculate the velocity acquired by the rock in this time, and also the distance it has travelled.
\end{enumerate}
