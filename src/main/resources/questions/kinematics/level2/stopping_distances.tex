...
%					%left: | l |
	\hline
	\textit{Speed}/ m\,s\sup{-1} & \textit{Thinking* distance}/ m & \textit{Braking distance$^{\dagger}$} / m & \textit{Overall distance} / m \\
	\hline
	5.0 & 3.0 & 1.9 & 4.9\\
	10 & 6.0 & 7.5 & 13.5 \\
	15 & 9.0 & 17 & 26 \\
  ...
  *The \textit{Thinking distance} is the distance travelled by the car during the driver's reaction time.
  ...
  \begin{enumerate}
	...
	\item \question[c]{Calculate the overall stopping distance for a car travelling at \quantity{50}{m\,s\sup{-1}}.}
	...
	\item \question[e]{Calculate the overall stopping distance for a car travelling at a speed of \valuedef{35}{m\,s\sup{-1}} down a hill at an angle of 10$^{\circ}$ to the horizontal.}
  \end{enumerate}
}
