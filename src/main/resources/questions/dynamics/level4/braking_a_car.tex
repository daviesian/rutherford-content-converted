...
{\begin{enumerate}
	\item When a car of mass \quantity{1000}{kg} is travelling along a level road at a steady \quantity{20}{m\,s\sup{-1}}, its engine is working at \quantity{18}{kW}. Find the total resistance due to friction, which may be taken to be constant.
	...
	\item Find also the distance in which the car would come to rest if the engine were disconnected and the brakes applied on an upward incline of angle \vari{\theta}, where \value{\sin(\theta)}{\frac{1}{20}}{}.
