%% ID: momentum
%% VIDEOS: 
%% QUESTIONS: head_on_collision, what_goes_up, energy_of_bullet, particles_on_string
%% CONCEPTS: momentum, energy, impulse, vectors, newtonii
%% LEVEL: 2
...
It is a \stress{vector} with units kg.m/s.

\subsection{Quick Questions*}
\qq{Two particles are moving in the same direction with momentum $10$ kg.m/s.  What is their total momentum?}{$20$ kg.m/s.}
\qq{Two particles are moving in opposite directions, each with momentum $10$ kg.m/s.  What is their total momentum?}{$0$ kg.m/s.}
...
\begin{figure}[h!]
\centering
\includegraphics[width=.7\linewidth]{isolated_inelastic.eps}
...
Momentum is \stress{always} conserved.  But energy can be converted to other forms (e.g. to heat) so collisions may or may not be elastic (that is conserving mechanical energy).  So one has:
\begin{equation*} 
...
\begin{figure}[h!]
\centering
\includegraphics[width=.7\linewidth]{elastic_wall.eps}
