...
\begin{problem}[HSC1930MIIIQ4p] % a standard question with a twist - picking up another mass
 {\exposition{Two masses \vari{3M} and \vari{2M} are suspended by a light string passing over a smooth peg. The system starts from rest and at the end of \vari{t} seconds the mass \vari{2M} picks up a mass \vari{4M} which was previously at rest.} \question{What is the time taken, \vari{T}, for the mass \vari{3M to come to rest (as a proportion of the time, \vari{t})?}}
