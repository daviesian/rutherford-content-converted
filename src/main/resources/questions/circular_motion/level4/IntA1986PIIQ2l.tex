...
{Since the magnitude of the centripetal force required for circular motion is \vari{mR\omega\sup2} and \value{F}{ma}{}, the magnitude of the centripetal acceleration is \vari{R\omega\sup2}. So initially
...
Substituting in \nll
\value{\omega\s0}{45}{rpm}= \quantity{45\cdot2\pi\cdot\frac{1}{60}}{rad\,s$\sup{-1}$} = \quantity{\frac{3}{2}\pi}{rad\,s$\sup{-1}$}\nll
and\nll
