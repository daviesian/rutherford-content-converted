...
\begin{equation} u_2 =   \frac{(m_1+m_2) \sqrt{2\mu gx}\cos \theta - m_1 u_1  \cos \alpha}{m_2}\end{equation} \value{u_2}{31.7}{m\,s$^{-1}$}
}
\end{problem}
%\end{document}
