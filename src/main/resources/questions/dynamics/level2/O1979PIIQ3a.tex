...
\begin{enumerate}
	\item The rock accelerates at 4.0 ms$^{-2}$; find the direction in which it moves with respect to North. What is the mass of the rock? \answer{Direction}{53.13}  \answer{m}{6.25}
	\item The forces continue to act so that the rock moves in a straight line for 6.0 s. Calculate the velocity acquired by the rock in this time, and also the distance it has travelled. \answer{v}{24.00}  \answer{s}{72.00}
\end{enumerate}
...
\begin{figure}[h]
	\centering
	\includegraphics[width=0.2\textwidth]{Dynamics_vtr_forces}
	\caption{}
