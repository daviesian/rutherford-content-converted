...
\examp{Let us take the example of our box but this time we are going to consider the box as one large object of mass \vari{3m} and also as three small boxes of mass $m$ each (figure \ref{NIII3}).\nl  By combining Newton I with Newton III, calculate the value of all the reaction forces (\vari{N_1} to \vari{N_3}) for the stack of boxes in equilibrium on the right of figure \ref{NIII3} and show that the left and right diagrams are equivalent.}{\\ $N_1-mg=0$, \\
$N_1+mg-N_2=0$,\\ $N_2+mg-N_3=0$ therefore \nll
\value{N_1}{mg}{,}  \value{N_2}{2mg}{,} \value{N_3}{3mg}{} and we can see that \value{N_3}{N}{} (left diagram) as it should.}
