...
\item
\begin{enumerate}
	\item This part has two steps; find the acceleration, then find the force. We can use the SUVAT equations to find the acceleration; the equation \value{v^{2}}{u^{2} + 2as}{} is the one required here. We have \value{v}{0}{m\,s\sup{-1}}, \value{u}{u}{} and \value{s}{h}{}:
\begin{align*} 
a &= \frac{v^{2} - u^{2}}{2s} \\ 
&= -\frac{u^{2}}{2h} 
\end{align*}
...
&= mg + \frac{mu^{2}}{2h} 
\end{align*}
	\item The work done by the tension is the force multiplied by the distance travelled in the direction the force acts: \vari{W} = \value{\vtr{F}\cdot\vtr{d}}{-Th}{} (as the tension acts in the opposite direction to the distance).
	\begin{align*} 
	\textrm{Work} &= -Th \\
...
&= mg - \frac{mu^{2}}{2h} 
\end{align*}
	\item The work done by the tension is the force multiplied by the distance travelled in the direction the force acts: \vari{W} = \value{\vtr{F}\cdot\vtr{d}}{Th}{}.
	\begin{align*} 
	\text{Work} &= Th \\
	&= \left(mg - \frac{mu^{2}}{2h}\right)h \\ 
	&= mgh - \frac{1}{2}mu^{2} 
