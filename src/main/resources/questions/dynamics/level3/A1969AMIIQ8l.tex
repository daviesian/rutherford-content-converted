...
\begin{hint}[A1969AMIIQ8l] %Standard multiple collision. Coefficient of restitution exorcised.
...
\begin{figure}[h]
  \centering
	...
	\centering
 	\includegraphics[width=0.5\linewidth]{Dynamics_ball_collision_AB}
	\caption{}
	\label{fig:Dynamics_ball_collision_AB}
	\end{subfigure}%
	\begin{subfigure}{0.5\textwidth}
	\centering
	\includegraphics[width=0.5\linewidth]{Dynamics_ball_collision_BC}
	\caption{}
