...
{Three identical particles \vari{A}, \vari{B}, and \vari{C} are moving in a plane and, at time \vari{t}, their position vectors, \vari{r_i} with respect to an origin \vari{O} are respectively,
\begin{eqnarray*} 
