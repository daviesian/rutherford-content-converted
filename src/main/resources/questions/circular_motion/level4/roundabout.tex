...
{
\begin{enumerate}
\item A car approaches a roundabout of radius \vari{R}. What is the maximum speed at which it can travel in order to go around without slipping, if the coefficient of friction between the road and car is $\mu$?
\item This time a racing car approaches a corner of radius \vari{R}, banked at an angle $\theta$ to the horizontal. 
\begin{enumerate}
