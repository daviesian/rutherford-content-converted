%% ID: 2part_moi
%% TITLE: Moment of inertia of 2 particles
%% TYPE: question
%% QUESTIONTYPE: scq
%% CONCEPTS: com, moi
%% VIDEOS: 
...
{\question{What is the moments of inertia of two point masses with mass vari{m_1} and \vari{m_2} separated by a distance \vari{l}, rotating around their common centre of mass?}
\begin{enumerate}
	\item \choice[a]{(m\s{1} + m\s{2})l^2}
	\item \choice[b]{\frac{m\s{1} + m\s{2}}{4} l^2}
	\item \choice[c]{\frac{m\s{1}~ m\s{2}}{(m\s{1} + m\s{2})} l^2}\correct
	\item \choice[d]{\frac{m\s{1}^2~ m\s{2}^2}{(m\s{1} + m\s{2})^2} l^2}
	\item \choice[e]{(\frac{m\s{1}^2}{m\s{2}} + \frac{m\s{2}^2}{m\s{1}}) l^2}
\end{enumerate}}
