...
\qq{Question: If the displacement is given by $s = 4t - 5 t^2$, what is v?}{
The instantaneous velocity $v$ is $\frac{\d s}{\d t}$. Thus,
\begin{equation}
...
\nll
\qq{Question: What is the acceleration of the displacement in question 1, $s = 4t - 5 t^2$?}{
\begin{equation}
