...
{\exposition{A particle of mass \vari{m_{1}} collides with a stationary particle of mass \vari{m_{2}} (\vari{m_{1}} $>$ \vari{m_{2}}).} \question{What is the maximum angle of deflection of mass \vari{m_{1}}?}} 
...
The maximum deflection angle is obtained when the velocity of mass \vari{m_{1}} forms a tangent to this circle, giving a deflection angle \vari{\phi}.

\answer{\vari{\sin{\phi}} $=$ \valuedef{\frac{v_1}{v_CM}}{\frac{m_2}{m_1}}{}}.  
}
\end{problem}
