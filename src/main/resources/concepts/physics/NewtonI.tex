...
[Where appropriate take the acceleration due to gravity to be, \valuedef{g}{10}{m\,s\sup{-2}}.]\nll
\qq{A box is being dragged along the floor by the tension, \valuedef{T}{10}{N}, in a rope, where the rope is inclined at an angle of $30^\circ$ to the ground.  If the box is moving at constant velocity what is the magnitude of the frictional force that must be acting on the box?  What is the magnitude of the normal reaction, \vari{N}, of the ground on the box if the mass of the box is \quantity{1}{kg}?}{\value{F}{T\cos(30)}{}= \quantity{5\sqrt{3}}{ N}; \nl
