...
{\begin{enumerate}
\item \exposition{A lift, of  mass \vari{m}, is travelling downwards at a speed \vari{u}. It is brought to rest by a constant acceleration over a distance \vari{h}.} 
\begin{enumerate} 
	\item \question[a]{What is the tension, \vari{T}, in the lift cable when the lift is stopping?}
	\item \question[b]{What is the work done by the tension whilst stopping the lift?}
...
\end{enumerate}
\begin{enumerate}
	\item \question[c]{What is the tension, \vari{T}, in the lift cable when the lift is stopping?}
	\item \question[d]{What is the work done by the tension whilst stopping the lift?}
\end{enumerate}
