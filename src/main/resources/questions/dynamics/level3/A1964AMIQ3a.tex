...
\begin{equation*} v_{n + h} = \frac{(m_{n} \times v_{n}) + (m_{h} \times v_{h})}{(m_{n} + m_{h})} = \frac{(0.007)(0)+ (0.25)(10)}{(0.007) + (0.25)} \textrm{ ms}^{-1} = 9.73 \textrm{ ms}^{-1}\end{equation*}
