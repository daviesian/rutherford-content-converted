...
{Momentum, $\vtr{p} = m\vtr{v}$, is always conserved in collisions; the total before a collision equals the total after, taking care of the directions.} \answer{$k = \frac{Mm(u + U)^{2}}$}
