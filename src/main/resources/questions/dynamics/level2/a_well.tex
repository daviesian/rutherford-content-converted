...
{\exposition{A sphere of polystyrene and a small sphere of lead, each of mass \quantity{0.2}{kg} are released together from rest and fall down a deep well with water at the bottom. The lead cube is found to take \quantity{4.0}{s} to reach the water surface.}
\begin{enumerate}
	\item \question[a]{Calculate the speed with which the lead cube hits the water?} 
	\item \question[b]{What is the depth of the well to the water's surface.}
	\item \exposition{The polystyrene cube takes \quantity{6.0}{s} longer to hit the water.} \question[c]Find the upward force, assumed constant, that must be acting on the polystyrene and explain why it is reasonable to assume it does not affect the lead.} 
\end{enumerate}
...
\begin{equation*}
\answer[a]{v = u + at = 0 + (9.8)(4) = \mbox{\quantity{39.2}{m\,s\sup{-1}}}}
\end{equation*} 

The depth of the well, \vari{d} is found from average velocity, \vari{\left(\frac{u + v}{2}\right)}, times time, \vari{t}:
\begin{equation*} 
\amswer[b]{d = \left(\frac{u + v}{2}\right)t = \left(\frac{39.2}{2}\right)(4) = \mbox{\quantity{78.4}{m}}}
\end{equation*}
...
\begin{equation*} 
\answer[c]{R = \text{Upward Force} = mg - ma = 0.2g - (0.2)(1.568) = \mbox{\quantity{1.6464}{N}} \approx \mbox{\quantity{1.65}{N}}} 
\end{equation*}
