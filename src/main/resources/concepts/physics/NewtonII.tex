%% ID: newtonii
%% VIDEOS: NewtonII.mp4
%% QUESTIONS: a_toboggan, firing_the_rockets, starting_w_basics, the_lift, a_well, on_ice, hammer_nail, pulleys_on_table, two_cubes, 
...
\qq{If a resultant force of $20$ N acts horizontally on a mass of $10$ kg, what will be the resulting acceleration, $a$?} {${\vtr a}={2}{m\,s^{-2}}$}
