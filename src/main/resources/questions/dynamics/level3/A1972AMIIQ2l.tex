...
\begin{figure}[h]
\centering
\includegraphics[width=0.2\textwidth]{Dynamics_gun_speeds}
\caption{}
...
The impulse is the change in momentum, and so the momentum of either body will give the horizontal impulse: $I = Mv = (1000)(3) \textrm{ kg ms}^{-1} = m(u \cos(\theta) - v) = (20)(153 - 3)  \textrm{ kg ms}^{-1} = 3000  \textrm{ kg ms}^{-1}$.
The kinetic energy produced by the explosion is then the sum of the two kinetic energies: $E = \frac{1}{2}Mv^{2} + \frac{1}{2}m\left[\frac{(u \cos(\theta) - v)}{\cos(\theta)}\right]^{2} = \frac{1}{2}(1000)(3)^{2} + \frac{1}{2}(20)(306 - 6)^{2} \textrm{ J} = 904500 \textrm{ J}$ where we have been careful to get the full speed of the projectile relative to the ground.

Impulse is measured in kg ms$^{-1}$ (kilogram metres per second) or Ns (Newton seconds), where the former is expressed in SI base units but the two are completely equivalent (this can be shown by subsituting in the definition $1 \textrm{ N} \equiv 1 \textrm{ kg ms}^{2}$). Energy is measured in J (Joules) or kg m$^{2}$s$^{-2}$ (kilogram meters squared per second squared), again equivalent units.
...
\begin{align*} a &= \frac{v^{2} - u^{2}}{2s} = \frac{-\left( \frac{-I}{M} \right)^{2}}{-2r} = \frac{I^{2}}{2M^{2}r} \\ &= \frac{(3000)^{2}}{2(1000)^{2}(0.25)} \textrm{ ms}^{-2} = 18 \textrm{ ms}^{-2} \end{align*}
and then $F = ma$ gives the force acting on the gun:
\begin{align*} F &= M \left( \frac{I^{2}}{2M^{2}r} \right) = \frac{I^{2}}{2Mr} \\ &= \frac{(3000)^{2}}{2(1000)(0.25)} \textrm{ N} = 18000 \textrm{ N} \end{align*}
...
\begin{equation*} F = \frac{\frac{1}{2}Mv^{2}}{r} = \frac{(1000)(3)^{2}}{2(0.25)} \textrm{ N} = 18000 \textrm{ N} \end{equation*} as before.
