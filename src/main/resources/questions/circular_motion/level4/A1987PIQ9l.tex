...
{The correct answer is (a). The tension from the extension, \value{T}{kx}{} can be equated to the force from the radial acceleration, \value{a\s{R}}{m\frac{v^{2}}{r}}, as these are the only two forces acting radially during the motion of \vari{m}. The velocity can be calculated from: \value{\frac{mv^{2}}{r}}{kx}. Since the extension, \vari{x} is \quantity{(0.70 - 0.50)}{m} = \quantity{0.20}{m}, \value{v}{\sqrt{\frac{kxr}{m}}} = \quantity{\sqrt{\frac{(40)(0.2)(0.7)}{0.05}}}{m\,s$\sup{-1}$ = \quantity{10.58}{m\,s$\sup{-1}$} \approx \quantity{11}{m\,s$\sup{-1}$}.}
\end{problem}