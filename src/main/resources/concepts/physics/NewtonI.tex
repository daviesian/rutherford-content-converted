...
\begin{itemize}
\item  \qq{A box is being dragged along a frictional floor by a tension, $T=10$ N, in a rope that is parallel to the ground.  If the box is moving at constant velocity what is the magnitude of the frictional force that must be acting on the box?}
{$F=10$ N}
\item \qq{A wooden block of mass, $10$ kg, rests on a frictional plane that is inclined at an angle of $30^\circ$ to the horizontal.  What is the magnitude and direction of normal reaction of the plane on the block if the block remains at rest?}
{Normal reaction $=10g\cos(30^\circ)=50\sqrt{3}$ N, direction is perpendicular to the plane}
\item \qq{A trailer of mass , $M$, containing 10 blocks, each of mass $m$, is at rest on a frictional plane that is inclined at an angle of $\theta$ to the vertical.  What is the magnitude and direction of the normal reaction of the plane on the trailer?}
