...
{\begin{enumerate}
	\item A gun of mass \value{M}{1000}{kg} stands on horizontal ground and can move horizontally against a recoil mechanism. With its barrel raised at an angle of $\theta=60^{\circ}$ to the ground, it fires a projectile of mass \value{m}{20}{kg} with a speed $u={306}$ {m\,s\sup{-1}} \stress{relative to the barrel}. Calculate the horizontal impulse on the gun and the total kinetic energy produced by the explosion which fired the projectile. Clearly state the units in which both quantities are measured.
