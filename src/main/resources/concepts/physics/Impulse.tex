%% ID: impulse
%% QUESTIONS: particles_on_string, pulleys_on_table, firing_a_canon, an_accident, water_wheel
...
When Newton described his second law of motion he said that an impulse causes a change in momentum in the direction that the impulse is applied.  We often find it useful to discuss this law in terms of a \stress{resultant} force and the rate of change of momentum (or for constant mass \valuedef{\vtr  F}{m{\vtr a}}{}) but thinking in terms of an impulse allows us to take into account the length of time for which the force is applied.\\
...
\caption{The graph of a constant force of \quantity{10}{N} applied to an object for \quantity{5}{s}.  The impulse that the object experiences is \valuedef{{\vtr F}t}{50}{N\,s} which is also given by the area under the line of the graph, shown in pink.}\label{impulse1}
\end{wrapfigure}
...
\qq{A broken down car of \quantity{1000}{kg} is pushed with a force of \quantity{50}{N} for \quantity{2}{minutes}.  If we neglect friction, what speed would the car finally reach?} {\valuedef{v}{6}{m\,s\sup{-1}} \quantity{=21.6}{kph} \quantity{=13.5}{mph}.}\nl
\qq{What force does a netball player apply to a ball of mass, \quantity{500}{g}, when she catches it from her team-mate if the ball is travelling at \quantity{5}{m\,s\sup{-1}} and it takes her \quantity{0.1}{s} to catch it?  How could she reduce the amount of force that she needs to apply?} {\valuedef{\vtr F}{-25}{N}, i.e. the force is in the opposite direction to the motion of the ball.}\nl
\qq{A perfectly hard air hockey puck of \quantity{50}{g}, is travelling towards you at \quantity{10}{m\,s\sup{-1}} and you want to send it back to your opponent at \quantity{15}{m\,s\sup{-1}}.  Your bat will be in contact with the puck for \quantity{0.01}{s}, what force do you need to apply to the puck?} {\valuedef{\vtr F}{-125}{N}, i.e. the force is in the opposite direction to the initial motion and in the direction back towards your opponent.}\nl
\qq{In July 2011 a baby fell 10 stories from a hotel window and was caught by a passer-by and they both survived (http://www.bbc.co.uk/news/magazine-14150524).  If the force that the catcher experienced was \quantity{30}{kN} over a period of \quantity{0.02}{s}, how fast was the baby falling just before the catch happened (we estimate the mass of the baby as \quantity{10}{kg})?} {\valuedef{u}{60}{m\,s\sup{-1}} downwards.}\nl
\qq{A squash ball, of mass \quantity{25}{g}, rebounds off a wall at \quantity{60}{m\,s\sup{-1}} and the wall exerts an force of \quantity{300}{N} for a period of \quantity{10}{ms}.  How fast is the ball going when it first collides with the wall?  Is your answer physically possible? If not why not?}{\valuedef{u}{60}{m\,s\sup{-1}} towards the wall.  This is not physically possible because in reality the collision will not be elastic.}
...
\noindent We can calculate the area under the force line by adding up the areas of a series of small rectangles of width \vari{\d t} from \valuedef{t}{0}{} to \valuedef{t}{t_f}{}. Using figure \ref{impulse2} we can see that the area of a small rectangle is given by the height of the rectangle \vari{\vtr F} multiplied by the width of the rectangle \vari{\d t}.  The instantaneous impulse, \vari{\d{\vtr I}} at time \vari{t} is therefore
\begin{equation}
\d{\vtr I} = {\vtr F}\d t
\end{equation}
The force-time graph in figure \ref{impulse2} shows that the force varies with time as a straight line, so \valuedef{\vtr F}{kt+c}{}, where the gradient of the line 
\begin{equation}
k=\frac{({\vtr F_f}-{\vtr F_i})}{t_f}
\end{equation}
and the vertical intercept, \valuedef{c}{\vtr F_i}{}, so therefore the force at any given time is.
\begin{equation}
...
\qq{An impulse is applied to a ball of mass, \quantity{500}{g}, according to the force-time relation shown in figure \ref{impulse2}  in the same direction as its initial velocity.  What is the final velocity of the ball if it has an initial velocity of \quantity{10}{m\,s\sup{-1}} and the parameters of the force-time graph are, \valuedef{t_f}{1}{s}, \valuedef{F_i}{5}{N} and \valuedef{F_f}{10}{N}.} {\valuedef{v}{25}{m\,s\sup{-1}} in the direction of motion.}\nl
\qq{A pram complete with baby (\quantity{20}{kg}) is left \quantity{1}{km} up along a straight path from the bottom of a hill which is inclined at \vari{30^\circ} to the horizontal. The pram's brakes fail and the pram begins to perfectly roll down the hill under gravity.   What impulse will be required to stop the pram at the bottom of the hill? [Let the acceleration due to gravity, \valuedef{g}{10}{m\,s\sup{-2}}].} {\valuedef{I}{2000}{N\,s} in the direction opposite to the motion of the pram.}\nl
...
{\vtr F}=-k{\vtr x} \nonumber
\end{equation}
and the extension of the spring in our example will change with time as \valuedef{x}{A\cos(\omega t)}{}.  Write down the integral expression for the impulse over the interval \valuedef{t}{0}{} to \vari{t'} that would allow us to calculate the velocity of the ball when it leaves the spring at time \vari{t'}. Using this expression what is the velocity of the steel ball after a time, \vari{t'}.}{[\valuedef{v}{\frac{-kA}{m}\int_0^{t'} \cos(\omega t) \d t}{},\ \  \valuedef{v}{\frac{kA\sin(\omega t')}{m\omega}}{}]}
