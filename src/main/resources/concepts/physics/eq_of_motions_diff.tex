...
\subsection*{Quick Question}
\qq{What is the acceleration of an object if its displacement is the same as that given in question 1, \valuedef{s}{4t - 5 t^2}{}?}{
\begin{equation}
a = \frac{\d^2 (4t - 5 t^2)}{\d t^2} = \frac{\d \left(4-10t\right)}{\d t} = \mbox{\quantity{- 10}{m\,s\sup{-2}}}
\end{equation}}
